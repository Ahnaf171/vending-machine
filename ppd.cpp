    ...
    while (!exitLoop)
    {
        ...
        else if (choice == "2")
        {
            ...
            while (!itemstock.get(item_id))
            {
                ...
                std::cout << RED << "The input you entered," << item_id << ", does not match any product ID number" << std::endl;
                std::cout << "Please enter a different ID number: " << RESET << std::endl;
                std::getline(std::cin, item_id);
            };
            if (itemstock.get(item_id))
            {
                ...
                std::cout << "You have selected " << '"' << itm->name << "-" << itm->description << '"' << ".This will cost you $" << RED<< prc.dollars << "." << prc.cents << RESET<<std::endl;
                ...
                else
                {
                    while (!invalid)
                    {
                        ...
                        {
                            std::cout << RED << "Error: wrong format of and currecny input" << RED << std::endl;
                            std::getline(std::cin, centz);
                        }
                    }
                    ...
                    {
                        std::cout << RED << "                      APOLOGIES       " << std::endl;
                        std::cout << "Error:" << cents / 100.0 << "$ is not a valid number denomination of money" << RESET << std::endl;
                        std::cout << "Please enter one of the following denominations(in cents): 5,10,20,50,100,200,500 or 1000" << std::endl;
                        std::cout << BLUE << "                      THANK YOU!       " << RESET << std::endl;
                        std::getline(std::cin, centz);
                        invalid = false;
                        while (!invalid)
                        {
                            ...
                            {
                                std::cout << RED << "                      APOLOGIES       " << std::endl;
                                std::cout << "Error wrong format of currecny" << RESET << std::endl;
                                std::cout << "Please enter one of the following number denominations(in cents): 5,10,20,50,100,200,500 or 1000" << std::endl;
                                std::cout << BLUE << "                      THANK YOU!       " << RESET << std::endl;
                                std::getline(std::cin, centz);
                            }
                        }
                    ...
                    while (remainder != 0)
                    {
                        if (remainder < 0)
                        {
                            ...
                            std::cout  << "You still need to give $" <<RED<<int_item << RESET << std::endl;
                            std::getline(std::cin, centz);
                            invalid = false;
                            while (!invalid)
                            {
                                ...
                                {
                                    std::cout << RED << "                      APOLOGIES       " << std::endl;
                                    std::cout << "Wrong format of currecny" << RESET << std::endl;
                                    std::cout << "Please enter one of the following number denominations(in cents): 5,10,20,50,100,200,500 or 1000" << std::endl;
                                    std::cout << BLUE << "                      THANK YOU!       " << RESET << std::endl;
                                    std::getline(std::cin, centz);
                                }
                            ...
                            {
                                std::cout << RED << "                      APOLOGIES       " << std::endl;
                                std::cout << "Error:" << cents / 100.0 << "$ is not a valid number denomination of money. Please try again." << RESET << std::endl;
                                std::cout << BLUE << "                      THANK YOU!       " << RESET << std::endl;
                                std::getline(std::cin, centz);
                                invalid = false;
                                while (!invalid)
            ...
            if (!to_menu)
            {
                ...
                std::cout << YELLOW << "Here is your " << itm->name << " and your change of $ " << final_total << ": " << final_c << RESET << std::endl;
                std::cout << BLUE << "               THANK YOU!        " << std::endl;
                std::cout << "           Please come again!        " << RESET << std::endl;
                if (menutype)
                {
                    choice = mainMenu();
                }
        ...
        { 
            std::cout<<YELLOW<<"                      HELP MENU"<< std::endl;
            std::cout<<"If you press 1, you will be able to see the items available for purchase"<< std::endl;
            std::cout<<"If you press 2, you will enter the purchase process."<< std::endl;
            std::cout<<"After that you will be required to input the item's id eg. I0002"<< std::endl;
            std::cout<<"Then you can input your amount to proceed with the purchase. Please enter NUMBERS with the accepted denominations.(The denominations will be mentioned if you input   the wrong one)"<< std::endl;
            std::cout<<"If you press 3, you will save your progress and exit the program."<< std::endl;
            std::cout<<"HOPE I WAS HELPFUL ENOUGH!"<< RESET<< std::endl;
            choice = mainMenu();
        ...
        {
            std::cout << RED << "  APOLOGIES       " << std::endl;
            std::cout << "Invalid Input" << RESET << "\n";
            std::cout << YELLOW << "Please enter a number betweem 1-9      " << RESET << std::endl;
            choice = mainMenu();
        }
    }
}
...
std::string mainMenu()
{
    ...
    std::cout << "Please select a option (1-10)" << std::endl;
